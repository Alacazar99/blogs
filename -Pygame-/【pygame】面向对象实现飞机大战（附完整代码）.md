【写在前面】：本人在网上，似乎还没有找到关于飞机大战的完整程序。基本都是讲了一些比较琐碎的小知识点。那么本篇文章呢，是使用**pygame 通过面向对象的方式**实现的“飞机大战”的**完整程序**的串讲。
...
---
###总结一下
本篇文章主要是理一下使用pygame面向对象编程的思路，说一下本文中程序的缺点吧，此程序其实部分功能没有实现，例如：关于加血道具那一块、以及我方战机的爆炸效果等。不把这个做的尽善尽美，也是为了看这篇文章的你能够有自己的【Idea】。能够学着自己去实现一种小小的功能。

【如果简书的朋友们有什么想法或者建议】欢迎留言。
【关于所使用的一些图片素材】，欢迎留言。
